  ...
  <div className="relative overflow-hidden border-0">
    ...
    <div className="relative z-10 flex items-center justify-center gap-4 py-2 px-4">
      <div className="flex items-center gap-2">
        ...
        <span 
          className="font-bold text-white tracking-wide text-sm sm:text-base" 
          style={{ fontFamily: 'FreeSet' }}
        >
...
const navbar = (
  <Navbar
    logo={
      <div className="flex items-center gap-3">
        ...
        />
        <span className="font-bold text-xl tracking-wide" style={{ fontFamily: 'FreeSet' }}>
          Pumki UI
        </span>
      </div>
    }
    projectLink="https://github.com/AnshSinghSonkhia/pumki-ui"
    projectIcon={
    ...
    chatLink="https://discord.gg/your-discord-server"
    chatIcon={
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
  ...
  >
    ...
    {/* Social Links - These will appear on the right */}
    <a 
...
const footer = <React.Fragment key="footer"><Footer /></React.Fragment>
